...
import com.coheser.app.databinding.FragmentFollowersAnalyticsBinding;
import com.coheser.app.databinding.ItemProgressChatLayoutBinding;
...
public class FollowersAnalyticsFragment extends Fragment implements View.OnClickListener {
    ...
    public FollowersAnalyticsFragment() {
        // Required empty public constructor
    }

    public static FollowersAnalyticsFragment newInstance() {
        FollowersAnalyticsFragment fragment = new FollowersAnalyticsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.followersExplainBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DetailMsgFragment fragment = DetailMsgFragment.newInstance(binding.getRoot().getContext().getString(R.string.followers), binding.getRoot().getContext().getString(R.string.followers_msg));
        ...
        binding.insightsExplainBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final DetailMsgFragment fragment = DetailMsgFragment.newInstance(binding.getRoot().getContext().getString(R.string.followers_insights), binding.getRoot().getContext().getString(R.string.followers_insights_msg));
                fragment.show(getChildFragmentManager(), "DetailMsgF");
            }
        });
    ...
    private void openBottomSheetforDate() {
        final DateSelectSheetFragment fragment = new DateSelectSheetFragment(new FragmentCallBack() {
            @Override
    ...
    private void openBottomSheetforCalender() {
        final CustomeCalenderFragment fragment = new CustomeCalenderFragment(new FragmentCallBack() {
            @Override
            public void onResponce(Bundle bundle) {
                if (bundle != null) {
                    startCalender.setTimeInMillis(bundle.getLong("startDate"));
