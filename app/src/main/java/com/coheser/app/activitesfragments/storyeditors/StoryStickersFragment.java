...
import com.coheser.app.adapters.StoryStickerAdapter;
import com.coheser.app.apiclasses.ApiLinks;
import com.coheser.app.databinding.FragmentStoryStickersBinding;
...
public class StoryStickersFragment extends Fragment {
    ...
    public StoryStickersFragment(FragmentCallBack callBack) {
    ...
    public static StoryStickersFragment newInstance(FragmentCallBack callBack) {
        StoryStickersFragment fragment = new StoryStickersFragment(callBack);
