...
import com.coheser.app.databinding.FragmentShowPostNotificationPermissionBinding;
...
public class ShowPostNotificationPermissionFragment extends BottomSheetDialogFragment {
    ...
    public ShowPostNotificationPermissionFragment(FragmentCallBack callback) {
    ...
    public static ShowPostNotificationPermissionFragment newInstance(FragmentCallBack callback) {
        ShowPostNotificationPermissionFragment fragment = new ShowPostNotificationPermissionFragment(callback);
