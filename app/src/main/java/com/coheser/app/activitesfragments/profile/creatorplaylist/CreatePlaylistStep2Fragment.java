...
public class CreatePlaylistStep2Fragment extends Fragment {
    ...
    public CreatePlaylistStep2Fragment(boolean isFromCreate, FragmentCallBack callBack) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemCountList.keySet().size()<11)
                {
                    ...
                    CreatePlaylistStep3Fragment f = new CreatePlaylistStep3Fragment(isFromCreate,new FragmentCallBack() {
                        @Override
